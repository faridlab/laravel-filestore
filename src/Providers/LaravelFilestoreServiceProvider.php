...
namespace Faridlab\LaravelFilestore\Providers;

use Illuminate\Support\ServiceProvider;

class LaravelFilestoreServiceProvider extends ServiceProvider
{
    /**
    ...
    public function boot()
    {
         ...
         */
        // $this->publishes([
        //     __DIR__.'/../../config/laravel-filestore.php' => config_path('laravel-filestore.php'),
        // ], 'config');
         ...
         */
        // $this->loadTranslationsFrom(__DIR__.'/../../resources/lang', 'laravel-filestore');
        // $this->loadJsonTranslationsFrom(__DIR__.'/../../resources/lang', 'laravel-filestore');
        // $this->publishes([
        //     __DIR__.'/../../resources/lang' => resource_path('lang/vendor/laravel-filestore'),
        // ], 'translations');
         ...
         */
        // $this->loadViewsFrom(__DIR__.'/../../resources/views', 'laravel-filestore');
        // $this->publishes([
        //     __DIR__.'/../../resources/views' => resource_path('views/vendor/laravel-filestore'),
        // ], 'views');
        ...
        //     $this->commands([
        //         \Faridlab\LaravelFilestore\Console\Commands\LaravelFilestoreCommand::class,
        //     ]);
        // }
         ...
         */
        // $this->publishes([
        //     __DIR__.'/../../public' => public_path('vendor/laravel-filestore'),
        // ], 'public');
    ...
    public function register()
    {
        ...
        //     __DIR__.'/../../config/laravel-filestore.php', 'laravel-filestore'
        // );
    }
}
